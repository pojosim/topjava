...
<section>
    ...
    <form method="post" action="${url}/meals/save">
        ...
        <dl>
            <dt><spring:message code="meal.table.title.calories"/>:</dt>
            <dd><input type="number" value="${meal.calories}" name="calories" required></dd>
        </dl>
        <button type="submit"><spring:message code="meal.button.save"/></button>
        <button onclick="window.history.back()" type="button"><spring:message code="meal.button.cancel"/></button>
    </form>
</section>
